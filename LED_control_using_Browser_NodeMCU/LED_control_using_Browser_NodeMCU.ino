...
const char* ssid = "Lenovo"; // SSID i.e. Service Set Identifier is the name of your WIFI
const char* password = "Krisbiswas"; // Your Wifi password, in case you have open network comment the whole statement.
